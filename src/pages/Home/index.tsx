...
export function Home() {
  ...
  return (
    <div className="bg-cream min-h-screen">
      ...
      {/* Hero */}
      <section className="bg-brown-dark text-white py-20 px-8 text-center">

        <div className='absolute top-[50] left-1/2 -translate-x-1/2 text-[200px] opacity-5 pointer-events-none select-none'>
          🐾
        </div>
      ...
      <section id="products" className="max-w-6xl mx-auto px-8 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {products.map((product) => (
            ...
            >
              {/* Product Image */}
              <div className="h-44 w-full overflow-hidden bg-cream">
                <img
                  src={product.cover}
                  alt={product.title}
              ...
              {/* Product Info */}
              <div className="p-4">
                <h3 className="font-serif text-base font-semibold text-brown-dark mb-1 leading-snug">
                  {product.title}
                </h3>
                ...
                <div className="flex items-center justify-between">
                  <strong className="text-lg font-medium text-brown-dark">
